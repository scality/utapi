...
const methods = {
    ...
    uploadPartCopy: { method: '_genericPushMetricUploadPart',
                      changesData: true },
...
class UtapiClient {
    ...
    */
    ...
    static getNormalizedTimestampSeconds() {
        const d = new Date();
    ...
    */
    pushMetric(metric, reqUid, params, cb) {
        ...
        let timestamp = UtapiClient.getNormalizedTimestamp();
        if (process.env.CI) {
            timestamp = UtapiClient.getNormalizedTimestampSeconds();
        }
