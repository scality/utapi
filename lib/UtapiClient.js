...
const converters = {
    ...
    _pushMetricDeleteMarkerObject: '_convertPushMetricDeleteMarkerObject',
    _pushMetricListBucketMultipartUploads: '_convertPushMetricListBucketMultipartUploads',
    ...
    _pushMetricDeleteBucket: '_convertPushMetricDeleteBucket',
};
    ...
    pushMetric(metric, reqUid, params, cb) {
        ...
        if (methods[metric] && this[methods[metric].method]) {
            ...
            return this[methods[metric].method](
                convertedParams, timestamp, metric, log, err => {
                    if (err) {
                        return callback(err);
                    }
    ...
    */
    ...
    _convertGenericPushMetricPutObject(params) {
        return {
            ...
            oldByteLength: !params.numberOfObjects ? params.incomingBytes - params.sizeDelta : null,
        };
    }
    ...
    _convertPushMetricDeleteMarkerObject(params) {
        return params;
    }

    _convertPushMetricDeleteBucket(params) {
        return params;
    }

    _convertPushMetricListBucketMultipartUploads(params) {
        return params;
    }

    _convertPushMetricCompleteMultipartUpload(params) {
        return {
            oldByteLength: !params.numberOfObjects ? params.sizeDelta * -1 : null,
        };
    }
